...
const DETAIL_LABELS = { Brand:"Brand", Affiliate_Username_2:"Affiliate Username 2", Requested_By_Name:"Requested By", Requested_At:"Requested At", Taken_By_Name:"Handler", Taken_At:"Taken At", BDT_Verified_By_Name:"BDT Verifier", BDT_Verified_At:"Verified At", Verification_Remark:"Verification Remark", Completed_By_Name:"Completed By", Completed_At:"Completed At", Unable_Reason:"Unable Reason", Resolution_Remark:"Resolution Remark", Waiting_Seconds:"Waiting Time", Handling_Seconds:"Handling Time", Total_Seconds:"Total Time" };
...
function requestDetailsText(r){return [getField(r,"Player_Username"),getField(r,"Affiliate_Username"),getField(r,"Affiliate_Username_2"),getField(r,"Phone_Number"),getField(r,"Email"),getField(r,"Transaction_ID")].filter(Boolean)}
