...
const ROLE_ACCESS = {
  ...
  SUPER_ADMIN: { views: ["dashboard", "new-request", "my-requests", "team-requests", "csp-queue"], defaultView: "dashboard", label: "Super Admin" }
};
...
function clearAuth() { localStorage.removeItem(TOKEN_STORAGE_KEY); authState.token = null; authState.user = null; }
